      ...
      <div className="App">
        ...
        <div className="content">
          <Routes>
            ...
            <Route path='/colores_de_fuerteventura_1' element={<Apartment title="Colores de Fuerteventura 1" images={apartment23Images} number={27} people={4} beds={3} surface={55}/>} />
            <Route path='/colores_de_fuerteventura_2' element={<Apartment title="Colores de Fuerteventura 2" images={apartment27Images} number={23} people={4} beds={3} surface={75}/>}/>
          </Routes>
        </div>
        <Footer/>
      </div>
